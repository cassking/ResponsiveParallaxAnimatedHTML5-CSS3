 ...
 */
 ///
//do not run scrollreveal.js on ios
 ///
var isMobile = {
    Android: function() {
 ...
 // if( !isMobile.any() ) alert('desktop - only run scrollreveal on desktop');
// if( isMobile.any() ) alert('mobile - disable animations on mobile and tablet');
...
//detect and only run on destkop
